...
public class TestingScript3 : MonoBehaviour {
  ...
  private void FlashColors() {
    ...
    mat2.GetComponent<ObjectColorFlash>().FlashColor(flashColor, 0.5f, ObjectColorFlash.ColorFlashMaterial.Unlit);
    mat3.GetComponent<ObjectColorFlash>().FlashColor(flashColor, ObjectColorFlash.ColorFlashMaterial.Lit);
  }
}
